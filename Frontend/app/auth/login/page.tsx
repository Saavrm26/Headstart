  ...
  return (
    <section className='bg-white '>
      ...
      <a href="/" className="flex items-center mb-6 text-2xl font-semibold text-gray-900">
        <div>
          <h1 className='text-4xl font-bold text-gray-900'>HeadStart</h1>
        </div>
      </a>
      <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0" style={{ borderColor: '#d1d5db' }}>
        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
          ...
          <form className="space-y-4 md:space-y-6" action="#">
            ...
            <button type="submit" className="w-full text-white bg-primary-600 hover:bg-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center" style={{ transition: 'background-color 0.3s' }}>
              Sign in
            </button>
