        ...
        <div className="w-full">
          ...
          <div className="flex items-center justify-center">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              <div className="relative flex flex-col justify-between rounded-md border border-stroke bg-white shadow-one">
                <div className="p-4">
                ...
                <div className="flex flex-1 flex-col justify-between">
                  <div className="flex-1 px-6 pt-2">
                    ...
                    <p className="mb-5 text-sm leading-relaxed text-body-color">
                      AI Tool is OpenAI + Next.js SaaS Boilerplate and Starter
                      kit crafted for those who are looking to build SaaS a...
                    </p>
                  </div>
